    ...
    <div class="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
            ...
            <div class="space-y-3">
                @foreach ([['May 29', 'Eid Al-Adha', 'success', 'Holiday'], ['Jun 15', 'Payroll Processing', 'info', 'Reminder'], ['Jun 21', 'Mid-Year Review', 'info', 'Reminder']] as [$date, $label, $variant, $badgeLabel])
                    <div class="flex items-center gap-3">
                        <div class="flex h-9 w-9 shrink-0 flex-col items-center justify-center rounded-lg border border-slate-100 bg-slate-50 text-center">
        ...
        <x-ui.card title="Quick actions">
            <div class="grid grid-cols-2 gap-2">
                <a href="{{ route('hr.employees.index') }}" class="flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-100">
                ...
                <a href="{{ route('hr.leave.index') }}" class="flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-100">
                ...
                <a href="{{ route('hr.payroll.index') }}" class="flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-100">
                ...
                <a href="{{ route('hr.reports.index') }}" class="flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-100">
